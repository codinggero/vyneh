...
class CnicBack extends StatefulWidget {
  static String route = '/CnicBack';

  const CnicBack({super.key});

  @override
  State<CnicBack> createState() => CnicBackState();
}

class CnicBackState extends State<CnicBack> {
  dynamic arguments;
  ...
  void registration() {
    arguments?.addAll({'cnicBack': image});
    ...
    return SafeArea(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Take a Photo of your CNIC Back Side')
                .text
                .size(30)
                .bold
                .make()
                .py24(),
            const Text(
                    'Take a picture of the back side of your national ID card'
